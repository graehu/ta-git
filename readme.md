...
A little tool for finding #tags in source and who authored them in git. Right now it only finds things in c++, python, and commit logs, because that's my use case.
...
Just including a sha1 wouldn't be that useful.
